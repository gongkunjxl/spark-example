#!/bin/bash
hadoop fs -rm -r /user/root/target/tmp/javaSVMWithSGDModel/*
function timediff() {
...
$SPARK_HOME/bin/spark-submit --master spark://master.gongkun.com:7077 --class org.apache.spark.examples.JavaPageRank --executor-memory 512m ./target/JavaPageRank-project-1.0.jar ./data.txt 2000
endtime=$(date +%s)
